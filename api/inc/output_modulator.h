...
extern "C" {
	...
	HAL_API uint32_t modulator_param_get_bitrate(modulator_param *pmod);
	HAL_API vatek_result modulator_param_reset(modulator_type type, modulator_param *pmod);
	HAL_API vatek_result modulator_param_reset_dvbt2(modulator_type type, modulator_param *pmod);
	HAL_API vatek_result modulator_param_set(vatek_device *hchip, modulator_param *pmod);
	HAL_API vatek_result modulator_param_get(vatek_device *hchip, modulator_param *pmod);
